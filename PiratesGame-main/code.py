...
class Player(GameSprite):
    ...
    def fire(self,direction):
        bullet = Bullet('PiratesGame-main/image/bullet.png', self.rect.centerx, self.rect.top+40, 15, 15, 15)
        if direction == "left":
...
back = transform.scale(image.load('PiratesGame-main/image/cave.png'),(1366,768)) # задаємо колір відповідно до колірної схеми RGB

packman = Player('PiratesGame-main/image/Pirat.png', 3, win_height - 90, 80, 85, 0, 0)
...
monster1 = Enemy('PiratesGame-main/image/Pumpkin.png', 328, 285, 50, 80, 5)
monster2 = Enemy('PiratesGame-main/image/Pumpkin.png', 988, 403, 50, 80, 3)
monster3 = Enemy('PiratesGame-main/image/Pumpkin.png', 1088, 488, 50, 80, 4)
monster4 = Enemy('PiratesGame-main/image/Pumpkin.png', 228, 240, 50, 80, 2)

coin1 = GameSprite('PiratesGame-main/image/coin.png', 330,60, 50,50)
coin2 = GameSprite('PiratesGame-main/image/coin.png', 990,530, 50,50)

shope = GameSprite('PiratesGame-main/image/shop.png', 930,430, 50,50)


final_sprite = GameSprite('PiratesGame-main/image/Pirat.png', win_width/2-100/2, win_height/2-100/2, 100, 100)
...
#перевірка, що гра ще не завершена
    if not finish:
        ...
        if sprite.spritecollide(packman, monsters, False):
            ...
            img = transform.scale(image.load("PiratesGame-main/image/lose.png"),(1366,768))
        ...
        if len(monsters) == 0:
            ...
            if sprite.collide_rect(packman, final_sprite):
                finish = True
                img = transform.scale(image.load("PiratesGame-main/image/win.png"),(1368,768))
                window.blit(img, (0, 0))

        if sprite.spritecollide(packman, shops, False) and open_shop == True:
            imge = transform.scale(image.load("PiratesGame-main/image/shop.back.jpg"),(1368,768))
            window.blit(imge, (0, 0))
            ware = sprite.Group()

            pick = GameSprite('PiratesGame-main/image/shop/pick.png', 100,230, 200,200)
            mapp = GameSprite('PiratesGame-main/image/shop/map.png', 550,230, 200,200)
            dig = GameSprite('PiratesGame-main/image/shop/dig.png', 1000,230, 200,200)
